...
time.sleep ( 1 )
cardNumber = input("Please enter your loyalty card eight digit ")
...
if NewcardExpiry < currentDate:
    print("Card has reached its expiry date")
...
########### Digit Conversation list to a string ###########
stringNumber = ''.join(map(str, numberList))

########### Digit Reverse Function ########### 
